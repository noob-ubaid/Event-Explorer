        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            <div>
              ...
              <p className="text-gray-400 mb-6">Discover and attend the most exciting events happening in your city.</p>
              <div className="flex space-x-4">
                <a href="https://www.facebook.com/share/1AGgdG4F9h/" className="text-gray-400 hover:text-white transition-colors duration-200">
                  <i className="fab fa-facebook-f text-lg"></i>
                </a>
                <a href="https://x.com/UbaidurRah24983?t=mA11h7v1LN7rB2ffFymKAg&s=08" className="text-gray-400 hover:text-white transition-colors duration-200">
                  <i className="fab fa-twitter text-lg"></i>
                </a>
                <a href="https://github.com/noob-ubaid" className="text-gray-400 hover:text-white transition-colors duration-200">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-400">Mirpur 1 , Dhaka , Bangladesh</span>
                </li>
                ...
                <li className="flex items-center">
                  ...
                  <span className="text-gray-400">eventfinder@gmail.com</span>
                </li>
              </ul>
          ...
          <div className="border-t border-gray-800 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-500 text-sm mb-4 md:mb-0">© 2025 EventFinder. All rights reserved.</p>
